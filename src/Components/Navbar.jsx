...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-100 shadow-sm px-4">
      {/* LEFT: logo + mobile dropdown button */}
      <div className="navbar-start">
        ...
        {/* Logo (same as before) */}
        <NavLink to="/" className="text-2xl font-bold ml-1">
      ...
      <div className="navbar-end gap-2">
        {!user ? (
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[60] p-2 shadow bg-base-200 rounded-box w-52"
            >
